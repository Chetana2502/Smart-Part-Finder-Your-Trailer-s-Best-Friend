...
DATA_DIR = r"C:\C\JSSATEB\Sasken Internship\Sasken-RAG-based-Trailer-Parts-Finder-main\SaskenGenAI\data"
...
# 🔄 Locate latest files
ebay_file = get_latest_file(os.path.join(DATA_DIR, "ebay_products_20250815_1653.json"))
tpu_file = get_latest_file(os.path.join(DATA_DIR, "trailerpartsunlimited_products_20250815_1654.json"))
